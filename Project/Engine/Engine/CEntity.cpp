...
void CEntity::SaveJsonFile(Json::Value& root)
{
	SaveWStringToJson(string("Name"), m_strName, &root);
}

void CEntity::LoadJsonFromFile(Json::Value& root)
{
	wstring name = LoadWStringFromJson("Name", &root);
	SetName(name);
}
