...
StructuredBuffer<matrix> SocketBuffer : register(t20);


#define Transform   g_mat_0
#define Scale       g_mat_1
#define Rot         g_mat_2
#define mat         g_mat_3

VTX_OUT VS_Socket2(VTX_IN _in)
{
