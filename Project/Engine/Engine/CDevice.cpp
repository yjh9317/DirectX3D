...
int CDevice::CreateSwapchain()
{
	...
	desc.BufferDesc.Format = DXGI_FORMAT_R8G8B8A8_UNORM;//DXGI_FORMAT_R16G16B16A16_FLOAT ,DXGI_FORMAT_R8G8B8A8_UNORM
...
void CDevice::CreateSamplerState()
{
	...
	tDesc.AddressV = D3D11_TEXTURE_ADDRESS_MODE::D3D11_TEXTURE_ADDRESS_WRAP;
	tDesc.AddressW = D3D11_TEXTURE_ADDRESS_MODE::D3D11_TEXTURE_ADDRESS_WRAP;
	tDesc.Filter = D3D11_FILTER::D3D11_FILTER_MIN_MAG_MIP_LINEAR;
	tDesc.MaxAnisotropy = 1;
	...
	DEVICE->CreateSamplerState(&tDesc, m_arrSam[3].GetAddressOf());
	...
	CONTEXT->VSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());
	CONTEXT->HSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());
	CONTEXT->DSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());
	CONTEXT->GSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());
	CONTEXT->PSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());
	CONTEXT->CSSetSamplers(2, 1, m_arrSam[2].GetAddressOf());

	CONTEXT->VSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
	CONTEXT->HSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
	CONTEXT->DSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
	CONTEXT->GSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
	CONTEXT->PSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
	CONTEXT->CSSetSamplers(3, 1, m_arrSam[3].GetAddressOf());
}
