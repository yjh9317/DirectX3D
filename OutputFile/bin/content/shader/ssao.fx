...
#define Res             g_vec2_0
#define ResRcp          g_vec2_1
#define ProjParams      g_vec4_0
#define ViewMatrix      g_mat_0
#define OffsetRadius    g_float_0
#define Radius          g_float_1
#define MaxDepth        g_float_2
